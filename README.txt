...
Ce projet est un exercice réalisé à l'école en cinq jours en décembre 2018. 

L'objectif est de coder un annuaire de films, sur lequel figurent neuf films de base. Projet réalisé à 3.
Outils : PHP, modèle MVC (utilisé pour la première fois), et SQL (notamment avec phpmyadmin).
